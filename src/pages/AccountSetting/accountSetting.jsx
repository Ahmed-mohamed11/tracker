...
export default function AccountSettings({ onClose }) {
    ...
    return (
        isVisible && (
            <div
                id="modalOverlay"
                className={`absolute z-50 inset-0 bg-black mt-20 bg-opacity-50 flex items-center justify-center transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}
