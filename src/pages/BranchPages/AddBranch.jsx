...
const AddBranch = ({ closeModal, modal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://bio.skyrsys.com/api/branch/branches/', data, {
                headers: {
            ...
            >
                <div className="relative p-4 bg-white dark:bg-gray-800 sm:p-5">
                    <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600 shadow-md shadow-gray-300/10">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">إضافة فرع</h2>
                        <button
                            type="button"
                            onClick={closeModal}
