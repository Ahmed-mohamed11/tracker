...
const EmployeeTable = ({ openCreate, data }) => {
  ...
  return (
    <div className="min-h-screen mt-10 w-full md:w-screen px-1 md:px-10 mx-auto">
      ...
      <div className="flex justify-between items-center mb-6 gap-14 w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full px-4">
          ...
          <button
            ...
            className="w-1/2 mx-auto md:mx-0  bg-themeColor-500 text-white text-center hover:bg-themeColor-700 px-4 py-2 rounded-md transition duration-200 flex justify-center items-center"
          >
            تصدير
