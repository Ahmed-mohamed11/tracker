...
import EmployeeRequestsReportsTable from "./EmployeeRequestsReportsTable";

const EmployeeRequestsReports = ({ role }) => {
...
export default EmployeeRequestsReports;
